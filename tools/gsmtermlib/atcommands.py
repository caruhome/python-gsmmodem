...
ATCOMMANDS = (
    ...
    (
        ...
        (
            ...
            None,
            None,
            "Displays the supported frequency bands. With multi-band products the response may be a combination of different bands.",
        ),
    ),
    (
        "AT+CGMR",
    ...
    (
        ...
        (
            ...
            None,
            None,
            "Allows the user application to get the IMEI (International Mobile Equipment Identity, 15-digit number) of the product.",
        ),
    ),
    (
        "AT+CSCS",
        (
            ...
            (
                (
                    "<Character Set>",
                    """GSM - GSM default alphabet (default value).
...
HEX - Hexadecimal mode. No character set used; the user can read or write hexadecimal values.""",
            ...
            None,
            "Informs the ME which character set is used by the TE. The ME can convert each character of \
...
HEX - Hexadecimal mode. No character set used; the user can read or write hexadecimal values.""",
            ...
            None,
            "Informs the ME which character set is used by the TE for the phonebooks. The ME can convert\
...
See also +CSCS for the short messages character sets.",
    ...
    (
        ...
        (
            ...
            None,
            None,
            "Reads and identifies the IMSI (International Mobile Subscriber Identity) of the SIM card. The PIN may need to be entered before reading the IMSI",
        ),
    ),
    (
        "AT+CCID",
    ...
    (
        ...
        (
            ...
            None,
            None,
            "Stops the GSM software stack as well as the hardware layer. The AT+CFUN=0 command is equivalent to +CPOF.",
        ),
    ),
    (
        "AT+CFUN",
...
1: Set the full functionality mode with a complete software reset""",
            ...
            None,
            "Selects the mobile station's level of functionality. When the application wants to stop the \
...
2: Enable error result codes with verbose (string) values""",
                ),
            ),
            None,
            'Disables or enables the use of the "+CME ERROR: <xxx>" or "+CMS ERROR:<xxx>" result code instead of simply "ERROR".',
        ),
    ),
    (
        "AT+CKPD",
        (
            ...
            None,
            "Emulates the ME keypad by sending each keystroke as a character in a <keys> string.\n\
...
depends on the GSM sequence activated.",
    ...
    (
        ...
        (
            ...
            None,
            "The ATD command sets a voice, data or fax call. As per GSM 02.30, the dial command also \
...
\nThere are other varieties of the ATD command available (using phonebook memory); please search online for help on these.",
    ...
    (
        ...
        (
            ...
            None,
            "The ATH (or ATH0) command disconnects the remote user. In the case of multiple calls, all calls are released \
...
application to accept the call with the ATA command.',
    ...
    (
        ...
        (
            c[1],
            "DTMF Signals - set tone duration",
            (
                (
                    "<v>",
            ...
            None,
            "The modem can send DTMF tones over the GSM network. This command is used \
...
See also: AT+VTS",
    ...
    (
        ...
        (
            c[1],
            "DTMF Signals - send tone",
            (("<Tone>", "DTMF tone to transmit. Tone is in {0-9, *, #, A, B, C, D}"),),
            None,
            "The modem can send DTMF tones over the GSM network. This command enables \
...
AT+VTS=1;+VTS=3;+VTS=#",
    ...
    (
        ...
        (
            ...
            None,
            None,
            'This command redials the last number used in the ATD command. The last number dialed is displayed followed by ";" for voice calls only.',
        ),
    ),
    (
        "AT%D",
...
Range of values is 0 to 255",
            ...
            None,
            "This S0 parameter determines and controls the modem automatic answering mode.",
        ),
    ),
    (
        "AT+CICB",
    ...
    (
        ...
        (
            ...
            (("<mode>", "0: Voice\n2: Fax\n4: Data"),),
            None,
            "This command selects the bearer to be used when an MT single numbering scheme call is set up (see +CICB).\nNote: Setting the +CSNS command affects the current value of +CICB.",
        ),
    ),
    (
        "AT+VGR",
        (
            c[1],
            "Gain Control - Reception",
            (("<Rgain>", "reception gain"),),
            None,
            "This command is used by the application to tune the receive gain of the speaker.",
        ),
    ),
    (
        "AT+VGT",
        (
            c[1],
            "Gain Control - Transmission",
            (("<Tgain>", "transmission gain"),),
            None,
            "This command is used by the application to tune the transmit gain of the microphone.",
        ),
    ),
    (
        "AT+CMUT",
        (
            ...
            (("<mode>", "0: microphone mute off (default)\n1: microphone mute on"),),
            None,
            "This command mutes the microphone input on the device. This command is only allowed during a call.",
        ),
    ),
    (
        "AT+CVHU",
...
2: "Drop DTR" behavior according to &D setting. ATH disconnects.',
            ...
            None,
            'This command selects whether ATH or "drop DTR" causes a voice connection to be disconnected or not. Voice connection also includes alternating mode calls that are currently in voice mode.\n\
...
3: registration denied.\n4: unknown.\n5: registered, roaming.",
    ...
    (
        ...
        (
            ...
            None,
            (
                ("<NumOper>", "the operator in numeric format"),
                ("<AlphaOper>", "the operator in long alphanumeric format"),
            ),
            "This command returns the list of all operator names (in numeric and alphanumeric format) stored in the module.",
        ),
    ),
    # Security
    (
        ...
        (
            ...
            (
                ...
                (
                    "<puk>",
                    "the personal unblocking key needed to change the PIN; syntax: AT+CPIN=<puk>,<new pin>",
                ),
            ),
            None,
            "This command enters the ME passwords (CHV1 / CHV2 / PUK1 / PUK2, etc.), that are required before any ME functionality can be used.",
        ),
    ),
    (
        "AT+CPIN2",
        (
            ...
            "Enter PIN2",
            (
                ("<pin2>", "the personal identification number 2"),
                (
                    "<puk2>",
                    "the personal unblocking key 2 needed to change the PIN 2; syntax: AT+CPIN=<puk2>,<new pin 2>",
                ),
            ),
            None,
...
length is 8 digits only.",
    ...
    (
        ...
        (
            ...
            None,
            (
                ("<n1>", "attempts left for PIN1 (0 = blocked, 3 max)"),
    ...
    (
        ...
        (
            ...
            (
                (
                    "<first_entry>",
                    "Location of phonebook entry or start of range of locations (if <last_entry> is specified) of the phonebook entries",
                ),
                ("<last_entry>", "End of range of locations of the phonebook entries"),
            ),
            None,
    ...
    (
        ...
        (
            ...
            (
                ...
                ("text>", "Text label/name of entry. String type"),
            ),
            None,
            'This command writes a phonebook entry in location number <index> in the current phonebook memory storage.\n\
...
1: SMS AT commands are compatible with GSM 07.05 Phase 2 + version",
            ...
            None,
            "The supported services include originated (SMS-MO) and terminated short messages (SMS-MT) as well as Cell Broadcast Message (SMS-CB) services.",
        ),
    ),
    (
        "AT+CNMA",
...
and <ds> parameters of the +CNMI command are then reset to zero (do not show new message indication).",
 ...
 "SR": Status Report message storage (in SIM if the EF-SMR file exists, otherwise in the ME non volatile memory)\n\
       Note: "SR" ME non-volatile memory is cleared when another SIM card is inserted. It is kept, even after a reset, while the same SIM card is used.',
                ...
                (
                    "<mem2>",
                    'Memory to be used to write and send messages\n "SM": SMS message storage in SIM (default)',
                ),
            ),
            (
                ("<used1>", "Used memory 1"),
                ("total1", "Total memory 1"),
                ("<used2>", "Used memory 2"),
                ("total2", "Total memory 2"),
            ),
    ...
    (
        ...
        (
            ...
            (
                (
                    "<mode>",
                    "Controls the processing of unsolicited result codes. Values:\n\
...
3: Forward unsolicited result codes directly to the TE. TA-TE link specific inband used to embed result codes and data when TA is in on-line data mode",
                ...
                (
                    "<mt>",
                    'Sets the result code indication routing for SM-DELIVERs. Default is 0. Values:\n\
...
3: Class 3 SMS-DELIVERs are routed directly using code in <mt>=2 ; Message of other classes result in indication <mt>=1',
                ...
                (
                    "<bm>",
                    'Set the rules for storing received CBMs (Cell Broadcast Message). Default is 0. Values:\n\
...
3: Class 3 CBMs: as <bm>=2. Other classes CBMs: as <bm>=1.',
                ...
                (
                    "<ds>",
                    'for SMS-STATUS-REPORTs. Default is 0. Values:\n\
...
1: TA buffer of unsolicited result codes defined within this command is cleared when <mode> 1...3 is entered.",
    ...
    (
        ...
        (
            c[5],
            "Read Message",
            (("<index>", "Location of message to read"),),
            None,
    ...
    (
        ...
        (
            ...
            (
                (
                    "<stat>",
                    'Status of messages in memory to list. Allowed values are:\n\
Text mode     PDU mode\n\
"REC UNREAD"  0\n\
"REC READ"    1\n\
"STO UNSENT"  2\n\
    ...
    (
        ...
        (
            ...
            (
                (
                    "<da>",
                    "Destination Address (text mode) - message destination phone number",
                ),
            ),
            None,
...
mode, only hexadecimal characters are used ('0'...'9','A'...'F').",
    ...
    (
        ...
        (
            ...
            (
                ("<index>", "location of stored message"),
    ...
    (
        ...
        (
            ...
            (
                ("<fo>", "byte comprising 6 fields, RP, UDHI, SRR, VPFG, RD and MTI"),
                ("<vp>", "validity period"),
                (
                    "<pid>",
                    "used to indicate the higher layer protocol being used or indicates interworking with a certain type of \
telematic device. For example, 0x22 is for group 3 telefax, 0x24 is for voice telephone, 0x25 is for ERMES.",
                ),
                ("<dcs>", "used to determine the way the information is encoded."),
            ),
            None,
            "This command selects a value for <vp>, <pid>, and <dcs>.",
        ),
    ),
    (
        "AT+CMGD",
        (
            ...
            (
                (
                    "<index>",
                    'Integer type values in the range of location numbers of SIM Message memory when the preferred message storage is "SM or "SR".',
                ),
                (
                    "<DelFlag>",
...
4: Delete All messages.",
            ...
            None,
            "This command deletes one or several messages from preferred message storage.",
        ),
    ),
    (
        "AT+CSCA",
        (
            ...
            None,
            "This command sets (or queries) the service center to which SMS messages must be sent.",
        ),
    ),
    (
        "AT+CSCB",
        (
            ...
            (
                (
                    "<mode>",
                    "0 - CBM reception activated\n1 - CBM reception deactivated",
                ),
                (
                    "<mids>",
                    "message identifiers - indicates the type of message idenitfiers for which the ME should listen",
                ),
    ...
    (
        ...
        (
            ...
            (
                (
                    "<n>",
                    "Sets the line ID restriction for outgoing calls. Values:\n\
...
1: CLIR invocation\n2: CLIR suppression",
            ...
            (
                (
                    "<m>",
                    "Shows the subscriber CLIR status in the network. Values:\n\
    ...
    (
        ...
        (
            ...
            (
                (
                    "<n>",
                    "Parameter sets/shows the result code presentation in the TA. Values:\n0: Disable\n1: Enable",
                ),
            ),
            (
                (
                    "<m>",
                    "Parameter shows the subscriber CLIP service status in the network. Values:\n0: CLIP not provisioned\n1: CLIP provisioned\n2: Unknown (no network...)",
                ),
            ),
...
1: call is one of multiparty (conference) call parties",
                ...
                (
                    "<alpha>",
                    "optional string type alphanumeric representation of <number> corresponding to the entry found in phonebook",
                ),
            ),
...
- Send and receive USSD strings",
    ...
    (
        ...
        (
            ...
            (("<n>", "0: Data\n1: Fax class 1\n2: Fax class 2"),),
            None,
            "This command puts the modem into a particular operating mode (data or fax).",
        ),
    ),
    ...
    (
        ...
        (
            c[7],
            "Cellular Result Dodes",
            (("<mode>", "0: Disable extended reports\n1: Enable extended reports"),),
            None,
            'This command shows more detailed ring information for an incoming call (voice or data). Instead of the string \
    ...
    (
        ...
        (
            ...
            (
                (
                    "<cid>",
                    "PDP Context Identifier - a numeric parameter (1-32) which specifies a particular \
PDP context definition. The parameter is local to the TE-MT interface and is used in \
other PDP context-related commands.",
                ),
                (
                    "<PDP_type>",
                    "A string parameter which specifies the type of packet data protocol. (IP, IPV6, PPP, X.25 etc)",
                ),
                (
                    "<APN>",
                    "Access Point Name. String parameter; logical name that is used to select the GGSN or external packet data network",
                ),
                (
                    "<PDP_address>",
                    "String parameter that identifies the MT in the address space applicable to the PDP. If null/omitted, a dynamic address may be requested.",
                ),
                (
                    "<d_comp>",
...
1 - on",
            ...
            None,
            "This command specifies the PDP (Packet Data Protocol) context parameter values, such as PDP type (IP, IPV6, PPP, X.25 etc), APN, data compression, header compression, etc.",
        ),
    ),
    (
        "AT+CGATT",
...
6: 7 Data 1 Stop\n\
   <parity> parameter is ignored",
            ...
            None,
            "This command determines the local serial port start-stop (asynchronous) character framing that the DCE uses.",
        ),
    ),
    ...
    (
        ...
        (
            ...
            None,
            None,
            "If a connection has been established and the ME is in command mode, this command allows you to return to online data mode.",
        ),
    ),
    (
        "ATQ",
    ...
    (
        ...
        (
            ...
            (
                (
                    "<n>",
                    "0: DCE transmits limited headers and trailers and numeric result codes\n1: DCE transmits full headers and trailers and verbose response text",
                ),
            ),
            None,
            "This command determines the DCE response format, with or without header characters <CR><LF>. Result codes are provided as numeric or verbose.",
        ),
    ),
    (
        "ATZ",
    ...
    (
        ...
        (
            c[10],
            "Echo",
            (("<n>", "0: Characters are not echoed\n1: Characters are echoed"),),
            None,
            "This command is used to determine whether the modem echoes characters received by an external application (DTE).",
        ),
    ),
    (
        "AT&F",
